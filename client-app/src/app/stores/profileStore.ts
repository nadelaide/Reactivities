...
export default class ProfileStore {
    ...
    constructor() {
        makeAutoObservable(this); //two above properties are automatically flagged by MobX
    ...
    loadProfile = async (username: string) => {//automatically binds to the class above
